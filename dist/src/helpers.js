...
const openzeppelin_upgrade_validation_1 = require("./openzeppelin-upgrade-validation");
...
function addHelpers(deploymentManager, partialExtension, network, getArtifact, saveDeployment, willSaveToDisk, onPendingTx, getGasPrice, log, print) {
    ...
    async function _deployViaEIP173Proxy(name, options) {
        ...
        await openzeppelin_upgrade_validation_1.openzeppelin_assertIsValidImplementation({
    ...
    `);
        ...
        if (viaAdminContract) {
            ...
            if (!proxyAdminDeployed) {
                const args = typeof (options === null || options === void 0 ? void 0 : options.proxy) === 'object' &&
                    typeof options.proxy.viaAdminContract === 'object'
                    ? ((_c = options.proxy.viaAdminContract) === null || _c === void 0 ? void 0 : _c.args) || [owner]
                    : [owner];
        ...
        if (!oldDeployment || implementation.newlyDeployed) {
            ...
            if (!proxy) {
                ...
                await openzeppelin_upgrade_validation_1.openzeppelin_assertIsValidUpgrade(provider, proxy.address, implementation);
            ...
            await openzeppelin_upgrade_validation_1.openzeppelin_saveDeploymentManifest(provider, proxy, implementation);
